...
export class HentaizoneScraper extends BaseScraper {
  readonly name = 'HentaiZone';
  readonly baseUrl = 'https://hentaizone.xyz';
  readonly lang = 'fr';
  ...
  private _parseDate(dateStr: string): number | undefined {
    ...
    const months: Record<string, string> = {
      ...
      'juil.': '07', 'juillet': '07', 'août': '08', 'aout': '08',
      'sept.': '09', 'septembre': '09', 'oct.': '10', 'octobre': '10',
      'nov.': '11', 'novembre': '11', 'déc.': '12', 'décembre': '12', 'decembre': '12',
