...
export class ResetscansScraper extends MadaraScraper {
  ...
  protected override readonly popularMangaUrlSelector = '.rs-manga-library__card a';
  protected override readonly searchMangaSelectorStr = '.rs-manga-library__card';
  protected override readonly searchMangaUrlSelector = '.rs-manga-library__card a';
