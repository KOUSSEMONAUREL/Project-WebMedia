...
export class WebcomicsScraper extends BaseScraper {
  readonly name = 'Webcomics';
  readonly baseUrl = 'https://webcomicsapp.com';
  readonly lang = 'en';
  private readonly apiUrl = 'https://popeye.${baseUrl.substringAfterLast(';
